...
dir_concat=/project/onibasu/Josh/glimpse2/3.4concat_tissue
dir_eagle=/project/onibasu/Josh/glimpse2/3.3eagle_tissue
dir_log=/project/onibasu/Josh/glimpse2/3.4concat_tissue_log
